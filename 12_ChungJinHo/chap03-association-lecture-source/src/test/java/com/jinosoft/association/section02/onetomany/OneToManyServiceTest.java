...
import com.jinosoft.association.section02.onetomany.Category;
import com.jinosoft.association.section02.onetomany.OneToManyService;
...
class OneToManyServiceTest {
  ...
  void nPlusOneTest(){
     ...
     * - 언제 조회? 처음에 모든 Category와 Menu를 조회함
     *
     * LAZY 일 때
     * - Category 조회 : 1회 (1차 캐시) + 14회 캐시 조회
     * - Category별 Menu 조회 : 14회
     * -
     *
     * */
